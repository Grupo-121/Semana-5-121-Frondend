...
<div id="login" class=" container bg-dark text-light mt-5 rounded mb-0 ml-100 mr-100 text-center">
  <form>
    <div class="form-group">
      <label for="exampleInputEmail1"><strong>Dirección de correo electrónico</strong></label>
      <input 
        v-model="login.email"
        type="email"
        class="form-control"
